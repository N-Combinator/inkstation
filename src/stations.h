/*
 * stations.h — bundled GB National Rail station list (GENERATED).
 *
 * Do not edit by hand. Regenerate with tools/gen_stations.py.
 * Source: Realtime Trains API /data/stops (namespace gb-nr).
 * Sorted by name so the search results read alphabetically.
 */
#ifndef INKSTATION_STATIONS_H
#define INKSTATION_STATIONS_H

typedef struct { const char *name; const char *crs; } station_t;
...
static const station_t STATIONS[] = {
    ...
    { "Brimsdown", "BMD" },
    { "Brinnington", "BNT" },
    { "Bristol International Airport", "XPB" },
    { "Bristol Parkway", "BPW" },
    { "Bristol Temple Meads", "BRI" },
    { "Brithdir", "BHD" },
    { "British Steel Redcar", "RBS" },
    { "Briton Ferry", "BNF" },
    { "Brixton", "BRX" },
    { "Broad Green", "BGE" },
    { "Broadbottom", "BDB" },
    ...
    { "Heath Low Level", "HLL" },
    { "Heathrow Airport Bus Station", "HTR" },
    { "Heathrow Airport Terminal 4", "HAF" },
    { "Heathrow Airport Terminal 4 (Bus)", "HWF" },
    { "Heathrow Airport Terminal 5", "HWV" },
    { "Heathrow Airport Terminal 5 (Bus)", "HWX" },
    ...
    { "St Margarets (Hertfordshire)", "SMT" },
